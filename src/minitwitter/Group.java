...
public class Group extends javax.swing.JFrame implements Observer, Element {

    String id;
    public ArrayList<String> myTweets = new ArrayList<>();
    public ArrayList<Group> followingUsers = new ArrayList<>();

    /**
     * Composite Design pattern
     */
    public ArrayList<Group> subGroups = new ArrayList<>();
    ...
    public void updateUserList() {
        ...
        Set<Group> s = new HashSet(AdminControlPanel.users);
        for (Group user : s) {
            allUserList.addItem(user);
        }
        for (Group user : followingUsers) {
    ...
    private void followUserBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_followUserBtnActionPerformed
        Group follower = (Group) allUserList.getSelectedItem();
    ...
    public void update(Group follower, String message) {
        updateNewsFeed();
        updateUserList();
        updateNewsFeed();
        updateFollowingUserList();
